...
- Seat locking now has a PostgreSQL RPC draft for expiring stale locks, creating active locks, and confirming assignments under database constraints. UI integration and live Supabase validation are still pending.
